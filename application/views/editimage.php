    ...
    <div class="row">
        <div class="col-12">
            <div class="card-box table-responsive">
                ...
                <form id="demo-form2" method="POST" action="<?=site_url('Product/update_image/'.$products->product_id)?>" enctype="multipart/form-data"  class="form-horizontal form-label-left" onkeypress="return event.keyCode != 13;">
                    ...
                    <div class="col-md-6 col-sm-6 col-xs-12">
                          <input id="image" class="form-control col-md-7 col-xs-12" name="image" placeholder="image" type="file" onchange="preview_image(this)">
                    </div>
                </div>
