    ...
    <div class="row">
        <div class="col-12">
            <div class="card-box table-responsive">
                ...
                <form id="demo-form2" method="POST" action="<?=site_url('Product/insert')?>"        enctype="multipart/form-data"  class="form-horizontal form-label-left" onkeypress="return event.keyCode != 13;">
                 ...
                 <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12 googleTranslateElementInit">
                          <input id="UID" class="form-control col-md-7 col-xs-12" name="UID" placeholder="UID " required="required" type="number">
                        </div>
                      ...
                      <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12 googleTranslateElementInit">
                          <input id="Productname" class="form-control col-md-7 col-xs-12" name="Productname" placeholder="Product Name" required="required" type="text">
                        </div>
                     ...
                     <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12 googleTranslateElementInit">
                          <input id="Model No" class="form-control col-md-7 col-xs-12" name="modelno" placeholder="Model No" required="required" type="number">
                        </div>
                      ...
                      <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input id="Price" class="form-control col-md-7 col-xs-12" name="Price" placeholder="Price" type="Price" required>
                        </div>
                      </div>
                ...
                <div class="item form-group">
                  ...
                  <div class="item form-group">
                    <label class="control-label col-md-3 col-sm-3 col-xs-12" for="image">Image<span class="required">* &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;(jpeg, jpg, png files only)</span>
                    </label>
                    <div class="col-md-6 col-sm-6 col-xs-12">
                          <input id="image" class="form-control col-md-7 col-xs-12" name="image" placeholder="Product Image" type="file" onchange="preview_image(this)">
                    </div>
                   </div>      
                      
                    
                <div class="item form-group">
                    <label class="control-label col-md-3 col-sm-3 col-xs-12" for="video">Video<span class="required">* &nbsp;(mp4, avi, flv, mov files only) </span>
                    </label>
                    <div class="col-md-6 col-sm-6 col-xs-12">
                      ...
                      <div class="form-group">
                        <div class="col-md-6 col-md-offset-3">
                          <a href="<?=site_url('Product/index')?>"><button type="button" class="btn btn-primary" >Cancel</button></a>
        ...
        if(isset($message)){ ?>
        alert("Video Format is not supporting");
        <?php } ?>
        </script>
...
<?php 
$message1=$this->session->flashdata('errorr');

if(isset($message1)){ ?>
alert("UID already existing");
<?php } ?>
</script>
